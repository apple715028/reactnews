...
const Technology = () => {
    const { data,loading,} = useFetchData('https://newsapi.org/v2/top-headlines?country=tw&pagesize=100&category=technology&w&apiKey=e736dab5c31746d88b6a41123753548c');    
