...
const Healthy = () => {
    const { data,loading,} = useFetchData('https://newsapi.org/v2/top-headlines?country=tw&pagesize=100&category=health&w&apiKey=e736dab5c31746d88b6a41123753548c');    
        ...
        {!loading && (
          <div>
                <div className="th_businessnews">
                    ...
                    <div className={`${data.articles.length <= postsPerPage ? "numberpage hiddele " : ""}`}> 
